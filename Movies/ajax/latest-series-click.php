...
$sel = "SELECT * FROM latest_series WHERE month_year = :my LIMIT 1";
...
if($res) {
	...
	if($res->rowCount() === 0) {
		$ins = "INSERT INTO latest_series (month_year, count) VALUES (:my, :count)";
		...
		$up = "UPDATE latest_series SET count = :num WHERE month_year = :my LIMIT 1";
