...
$sel = "SELECT * FROM trending WHERE month_year = :my LIMIT 1";
...
if($res) {
	...
	if($res->rowCount() === 0) {
		$ins = "INSERT INTO trending (month_year, count) VALUES (:my, :count)";
		...
		$up = "UPDATE trending SET count = :num WHERE month_year = :my LIMIT 1";
