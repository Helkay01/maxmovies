...
$sel = "SELECT * FROM old_movies WHERE month_year = :my LIMIT 1";
...
if($res) {
	...
	if($res->rowCount() === 0) {
		$ins = "INSERT INTO old_movies (month_year, count) VALUES (:my, :count)";
		...
		$up = "UPDATE old_movies SET count = :num WHERE month_year = :my LIMIT 1";
