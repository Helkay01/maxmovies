...
$sel = "SELECT * FROM latest_movies WHERE month_year = :my LIMIT 1";
...
if($res) {
	...
	if($res->rowCount() === 0) {
		$ins = "INSERT INTO latest_movies (month_year, count) VALUES (:my, :count)";
		...
		$up = "UPDATE latest_movies SET count = :num WHERE month_year = :my LIMIT 1";
