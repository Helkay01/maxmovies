...
$sel = "SELECT * FROM bollywood WHERE month_year = :my LIMIT 1";
...
if($res) {
	...
	if($res->rowCount() === 0) {
		$ins = "INSERT INTO bollywood (month_year, count) VALUES (:my, :count)";
		...
		$up = "UPDATE bollywood SET count = :num WHERE month_year = :my LIMIT 1";
