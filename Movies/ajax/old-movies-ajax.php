...
$sel = "SELECT * FROM old_movies WHERE today = :day";
...
$ins = "INSERT INTO old_movies (today, m_cached) VALUES (:days, :cached)";
...
$url = 'https://fzmovies.net/year.php';

$arr = array("2000", "2001", "1998", "1995", "2001");
$rand = rand(0, 4);
