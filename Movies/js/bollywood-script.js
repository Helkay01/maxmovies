$("document").ready(function() {
	...
	$.ajax({
		url: 'http://0.0.0.0:8080/ajax/latest-bollywood-ajax.php',
		...
		success: function(data) {	
			...
			if(data !== "" && data.match("img")) {
				...
				$("div#search-result").html('<center style="width: 100vw; "><big><i>Error occured. Please <a style="font-weight: bold; color: red;" href="http://0.0.0.0:8080/search.php">search</a>  for bollywood movies or <a style="font-weight: bold; color: red;" href="'+page+'">reload</a> this page. You can also check new release bollywood movies on the movie database => <a style="color: green; font-weight: bold;" href="https://www.imdb.com/search/title/?title_type=feature&countries=in&languages=hi">IMDB</a> and download here. <br><br><br></i></big></center>');
				$("div#loader").hide();
			}
		}
	})
